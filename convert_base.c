...
unsigned int convert_sbase(buffer_t *output, long int num, char *base,
		unsigned char flags, int wid, int prec);
/**
 * convert_sbase - Converts a signed log.
...
/**
 * convert_ubase - converts unsigned log to given base
 * @output: buffer_t struct containing char array.
 * @wid: width modifier.
 * @prec: precision modifier.
 * @flags: Flag modifiers.
 * @num: An unsigned long to be converted.
 * @base: pointer to a string bthat contains what to convert.
 *
 * Return: stored bytes number.
 */
unsigned int convert_ubase(buffer_t *output, unsigned long int num, char *base,
		unsigned char flags, int wid, int prec)
{
